...
<head>
  ...
  <meta name="description" content="Centro de adicciones en Buenos Aires. Rehabilitacion de adicciones.Tenemos el programa más efectivo para dejar las drogas.">
  <meta name="author" content="emanuel">
  <meta name="generator" content="Hugo 0.84.0">
  <meta name="keywords" content="comunidad terapeutica, tratamiento de adicciones, recuperación de adictos, alcoholismo, internacion por drogas, rehabilitacion de drogas y alcoholismo">

  <title>Rehabilitacion de adicciones</title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-78KDWS0TQ2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-78KDWS0TQ2');
</script>
</head>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" ms-2 id="navbarCollapse">
          ...
          <form class="d-flex">
            ...
            <a href="ubicacion.php"><img src="images/comoiracentrosoltar.png" class="comoiracentrosoltar"></a>
          </form>
        </div>
      </div>
    </nav>
        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption text-start">
              ...
              <p><a class="btn btn-lg btn-primary" href="aprende.php">Aprendé más </a></p>
            </div>
          </div>
        </div>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p>El equipo de Soltar , es un equipo multidisciplinario abocado a la recuperación , reinserción
        ...
        <div class="col-md-5 mt-5 pt-5">
          <img src="images/profesionalesenrecuperaciondeadicciones.png" width="500" height="500" class="img-fluid">
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7 order-md-2">
          ...
          <p>Utilizamos el mundialmente reconocido Programa Minessota basado en los Doce Pasos , por su
        ...
        <div class="col-md-5 order-md-1">
          <img src="images/programaminessota.png" width="500" height="500" class="img-fluid" >
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-2 md-5 order-md-1 ">
        </div> 
          <iframe width="500" height="500"  src="https://www.youtube.com/embed/7wJvkIautCk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      ...
      <footer class="container">
        ...
        <p>2021 copyright centro soltar&copy;  &middot; <a href="mailto:infocentrosoltarinternacion@gmail.com">infocentrosoltarinternacion@gmail.com</a> &middot;   
        </p>

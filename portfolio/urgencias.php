    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" ms-2 id="navbarCollapse">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="urgencias.php">Urgencias</a>
          </li>
        </ul>
    ...
    <div class="container">
      <div class="container marketing">
          ...
          <div class="row featurette mt-5">
            <div class="col-md-7">
            <h2 class="featurette-heading">Llamanos las 24 hs los </Em> <span class="text-muted"><br>365 dias del año.</span></h2>
            <p class="lead-urgencias"> Cel: 11-7009-6760<br> mail: centrosoltar@gmail.com
            </p>
            </div>
            <div class="col-md-5 mt-5 pt-5">
            <img src="images/telefono de centros de adicciones.png">
            </div>
            <a onclick="gtag_report_conversion(url);" href="tel:+541170096760"> <img class="call-move" style="text-shadow: 2px 2px 4px #000000" src="images/24-hours.svg" alt="Image" width="5%"></a>
          </div>
      </div>
